...
var AuthorTool = function (_React$PureComponent) {
    ...
    return metaValues.props.map(function (prop) {
      ...
      if (runtimeValue !== undefined) {
        if (runtimeValue && {}.toString.call(runtimeValue) === '[object Function]') {
          currentPropValue = React.createElement(
            'em',
            null,
            'function'
          );
  ...
  AuthorTool.prototype.handleFormatComponent = function handleFormatComponent(runtimeValues) {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'author-component-view', ref: function ref(inner) {
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('img', { className: 'icon-link-image',
          ...
          React.createElement(
            ...
            React.createElement(
              'span',
              { style: { fontFamily: 'courier', fontSize: '12px', marginTop: '8px' } },
              'docs'
            )
          )
        )
  ...
  AuthorTool.prototype.render = function render() {
    ...
    return React.createElement(
      'div',
      { className: 'component-debug-view', style: addBorder, ref: function ref(_ref) {
          return _this4._refContainer = _ref;
        } },
      props.component,
      React.createElement('button', { className: 'author-view-button',
        style: putButtonBack,
        onClick: this.handleClick,
        'data-tip': true, 'data-for': props.uniqueKey
      }),
      React.createElement(
        ReactTooltip,
        {
